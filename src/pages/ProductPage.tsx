            ...
            {(product.materials || product.dimensions) && (
              <div className="py-6 border-t border-border space-y-6">
                ...
                <dl className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  {product.dimensions && (
                    <>
                      <dt className="text-muted-foreground">Dimensions (W×H×D)</dt>
                  ...
                  <dd className="font-medium">
                    {product.dimensions ? Math.round((product.dimensions.width * product.dimensions.height * product.dimensions.depth) / 10000) : 25} kg
                  </dd>
                </dl>
                ...
                <div className="pt-4 border-t">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>• Free standard delivery (5-7 business days)</li>
                    <li>• Express delivery available (2-3 business days)</li>
                    <li>• White glove delivery service available</li>
                    <li>• Assembly service can be added at checkout</li>
                  </ul>
                </div>

                {/* Warranty */}
                <div className="pt-4 border-t">
                  <h4 className="font-medium mb-3">Warranty & Returns</h4>
                  <ul className="space-y-2 text-sm text-muted-foreground">
